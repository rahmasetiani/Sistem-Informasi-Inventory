...
<br>
       ...
       <!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <marquee><h2>Selamat Datang di Sistem Informasi Inventory Barang | Repost by Gudangku </a>
      </marquee></h2>
		  <br></br>
          <!-- Content Row -->
          <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                     <a  href="?page=datakondisi"> <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><h4>Data Kondisi </h4></div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
