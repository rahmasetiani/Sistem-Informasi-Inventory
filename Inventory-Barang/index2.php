	   ...
	   <li class="nav-item active">
        ...
        <div id="collapseData" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=kondisibarang">Kondisi Barang Keluar</a>
      ...
      <div class="sidebar-heading">
        ...
        <div id="collapseLaporan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=laporan_datakondisi">Laporan Data Kondisi </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
         ...
         if ($page == "kondisibarang") {
          if ($aksi == "") {
            include "page/kondisibarang/kondisibarang.php";
          }
           if ($aksi == "tambahkondisi") {
            include "page//kondisibarang/tambahkondisi.php";
          }
           if ($aksi == "ubahkondisi") {
            include "page/kondisibarang/ubahkondisi.php";
          }
          
           if ($aksi == "hapuskondisi") {
            include "page/kondisibarang/hapuskondisi.php";
          }
        }
         ...
         if ($page == "datakondisi") {
          if ($aksi == "") {
            include "page/datakondisi/datakondisi.php";
          }
        }
         ...
         if ($page == "laporan_datakondisi") {
          if ($aksi == "") {
            include "page/laporan/laporan_datakondisi.php";
          }
         }
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Your Website 2023 | Repost by Gudangku
            </span>
          </div>
        </div>
      </footer>
...
<script>
jQuery(document).ready(function($) {
   $('#cmb_kondisi').change(function() { // Jika Select Box id provinsi dipilih
     var tamp = $(this).val(); // Ciptakan variabel provinsi
     $.ajax({
            type: 'POST', // Metode pengiriman data menggunakan POST
          url: 'page/barangmasuk/get_kondisibarang.php', // File yang akan memproses data
         data: 'tamp=' + tamp, // Data yang akan dikirim ke file pemroses
         success: function(data) { // Jika berhasil
...
<script type="text/javascript">
    jQuery(document).ready(function($){
        $(function(){
    $('#cmb_kondisibarang').submit(function() {
        $.ajax({
            type: 'POST',
            url: 'page/barangkeluar/tambahbarangkeluar.php',
            data: $(this).serialize(),
            success: function(data) {
             $(".tampung3").html(data);
             $('.table').DataTable();
