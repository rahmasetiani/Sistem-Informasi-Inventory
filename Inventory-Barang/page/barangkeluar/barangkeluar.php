                    ...
                    <?php 
									...
									?>
                                        ...
                                        <tr>
                							...
                							<submit class="btn btn-danger btn-sm"><?php echo $data['kondisibarang'] ?></submit>
            								</td>											
											<td><?php echo $data['keterangan'] ?></td>
								

											<td>
											<a href="?page=barangkeluar&aksi=ubahbarangkeluar&id_transaksi=<?php echo $data['id_transaksi'] ?>" class="btn btn-success" >Ubah</a>
